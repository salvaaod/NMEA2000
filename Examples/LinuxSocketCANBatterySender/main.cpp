...
// NMEA2000_socketCAN constructor currently takes char* (not const char*),
// so keep interface name in a writable array to avoid -Wwrite-strings warning.
static char SocketCANPort[] = "can0";
#define SOCKET_CAN_PORT SocketCANPort
